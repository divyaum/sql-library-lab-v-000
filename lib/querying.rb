...
def select_series_title_with_most_human_characters
  "SELECT series.title from series join books on books.series_id = series.id join character_books on character_books.book_id = books.id join characters on characters.
end
